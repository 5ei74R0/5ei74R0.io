<template>
  <div
    class="my-16 w-11/12 max-w-screen-md bg-nord-aurora-5 dark:bg-nord-night-3 bg-[url('/images/bg-sketch1.png')] bg-blend-overlay border border-nord-snow-1 dark:border-nord-night-2 rounded-lg shadow">
    <div class="flex flex-col items-center pb-10">
      <img class="w-32 h-32 mt-8 mb-4 rounded-full shadow-lg" src="https://avatars.githubusercontent.com/u/56509932?v=4"
        alt="" />
      ...
      <div class="my-2 flex">
        <NuxtLink to="https://github.com/5ei74R0" class="text-nord-snow-0 hover:text-nord-snow-2">
          <svg class="h-5 mx-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
        ...
        <NuxtLink to="https://scholar.google.co.jp/citations?user=koZVTJ4AAAAJ" class="text-nord-snow-0 hover:text-nord-snow-2">
          <svg class="h-5 mx-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <NuxtLink to="https://zenn.dev/5ei74r0" class="text-nord-snow-0 hover:text-nord-snow-2">
        <svg class="h-5 mx-2" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" >
      ...
      <p class="mt-2 md:mt-4 space-x-3 mx-auto w-5/6 font-normal text-left text-nord-snow-2 dark:text-nord-snow-0 bg-clip-padding backdrop-filter backdrop-blur bg-opacity-0 rounded-md p-2">
        Hey there!<br />
